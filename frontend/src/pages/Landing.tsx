    ...
    <>
      <main className="landing-wrap">
        <section className="hero-card">
          ...
          <div className="hero-logo" style={{display: "flex", alignItems: "center", justifyContent: "center", gap: 12}}>
            <Logo size={48}/>
          </div>

          <h3 className="hero-title">Query your data. No SQL. No formulas</h3>
          <p className="hero-sub">
            Convert Spanish and English questions to database queries instantly. Get clear
